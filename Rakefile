...
task :install_formulas do
  ...
  #
  %w(wget git mysql imagemagick ack proctools fortune htop watch lynx gcal tmux macvim reattach-to-user-namespace bash-completion ctags).each do |formula_name|
